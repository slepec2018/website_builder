...
export class ChooseElementComponent extends AbstractComponent {
  ...
  _getTemplate() {
    return `<div class="choose-elem hidden-block">
              <button class="choose-elem__btn" type="button" data-element="h1">Title H1</button>
              <button class="choose-elem__btn" type="button" data-element="h2">Title H2</button>
              <button class="choose-elem__btn" type="button" data-element="h3">Title H3</button>
              <button class="choose-elem__btn" type="button" data-element="p">Paragraph</button>
